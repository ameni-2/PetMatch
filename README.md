# PetMatch
PetMatch est une application web de mise en relation pour animaux de compagnie, inspirée de Bumble. Elle permet aux propriétaires d'animaux de créer un profil pour leur animal (nom, espèce, race, âge, photo) et de swiper sur les profils d'autres animaux près de chez eux.
